        ...
        </div>
        {
            [1, 2, 3].map((item) => (
                <nav key={item} className='grid gap-2'>
                    <p className='text-lg mb-3'>产品介绍</p>
                    <a href="">产品介绍1</a><a href="">产品介绍2</a><a href="">产品介绍3</a><a href="">产品介绍4</a><a href="">产品介绍5</a>
                </nav>
            ))
        }
        <nav className='grid gap-2 content-start'>
            <p className='text-lg text-black mb-3'>注册</p>
            <p>注册注册注册注册注册注册注册注册注册注册注册</p>
            <input type="text" className='py-2 px-3 border' placeholder='您的邮箱' />
        </nav>
        <div className='col-span-full mt-12 border-t py-3 flex flex-col gap-4 justify-between md:flex-row text-sm'>
            <p>&copy; {" "} <a href="#" className='text-blue-500'>Cruip</a>{" "}. All rights reserved.</p>
            <p className='flex gap-4 justify-items-center'>
                <a href="">
                    <svg
                    width="30"
                    height="30"
