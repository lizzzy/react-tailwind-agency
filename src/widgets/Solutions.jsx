...
import Img1 from '../assets/pexels-photo-8348457.jpg'

function Solutions() {
  return (
    <div>
      <SectionHeading title='解决方案' subTitle='从零使用 React + Tailwind CSS 制作响应式网站' />
      <div className='grid lg:grid-cols-2 mt-20 gap-20'>
        <div>
            <h3 className='mt-7 text-[32px] font-bold'>强有力的工具</h3>
            <p className='mt-4 mb-8 text-gray-500'>这期视频，我们使用 Vite 创建 React 项目，配置 Tailwind CSS，制作一个响应式的企业官网，从这个视频中，你会提高 HTML 和 CSS 的布局能力。</p>
